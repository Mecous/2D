...
/*!
  \file generator_short_dribble.h
...
#ifndef GENERATOR_SHORT_DRIBBLE_H
#define GENERATOR_SHORT_DRIBBLE_H
...
private:
    ...
    // not used
    GeneratorShortDribble( const GeneratorShortDribble & );
    GeneratorShortDribble & operator=( const GeneratorShortDribble & );
public:
