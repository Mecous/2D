...
#include "bhv_side_back_dribble_defensive_move.h"
 ...
 */
bool
Bhv_SideBackDribbleDefensiveMove::execute( PlayerAgent * agent )
{
 ...
 */
bool
Bhv_SideBackDribbleDefensiveMove::doIntercept( PlayerAgent * agent )
{
 ...
 */
bool
Bhv_SideBackDribbleDefensiveMove::doAttackBallOwner( PlayerAgent * agent )
{
    const WorldModel & wm = agent->world();
    ...
    if ( fastest_opp == mark_target )
    {
        ...
        if ( Bhv_SideBackBlockBallOwnerDribble( bounding_rect ).execute( agent ) )
        {
 ...
 */
bool
Bhv_SideBackDribbleDefensiveMove::doEmergencyMove( PlayerAgent * agent )
{
    const WorldModel & wm = agent->world();
 ...
 */
bool
Bhv_SideBackDribbleDefensiveMove::doMark( PlayerAgent * agent )
{
    const WorldModel & wm = agent->world();
 ...
 */
void
Bhv_SideBackDribbleDefensiveMove::doNormalMove( PlayerAgent * agent )
{
    const WorldModel & wm = agent->world();
 ...
 */
void
Bhv_SideBackDribbleDefensiveMove::doGoToPoint( PlayerAgent * agent,
