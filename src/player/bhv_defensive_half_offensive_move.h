...
#ifndef BHV_DEFENSIVE_HALF_OFFENSIVE_MOVE_H
#define BHV_DEFENSIVE_HALF_OFFENSIVE_MOVE_H
...
class Bhv_DefensiveHalfOffensiveMove
    : public rcsc::SoccerBehavior {
public:
    Bhv_DefensiveHalfOffensiveMove()
      { }
