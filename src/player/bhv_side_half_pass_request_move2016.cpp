 ...
 */
bool
Bhv_SideHalfPassRequestMove2016::execute( PlayerAgent * agent )
{
 ...
 */
void
Bhv_SideHalfPassRequestMove2016::doGoToPoint( PlayerAgent * agent,
                                              const Vector2D & target_point )
{
    ...
    if ( wait_step > 0 )
    {
        ...
        agent->debugClient().addMessage( "SH:PassReqMoveWait" );
        dlog.addText( Logger::TEAM | Logger::ROLE,
    ...
    {
        agent->debugClient().addMessage( "SH:PassReqMoveAdjust" );
    }
    ...
    {
        // still moving
        agent->debugClient().addMessage( "SH:PassReqMoveGoTo" );
        dlog.addText( Logger::TEAM | Logger::ROLE,
    ...
    else
    {
        ...
        agent->debugClient().addMessage( "SH:PassReqMoveTurn" );
        dlog.addText( Logger::TEAM | Logger::ROLE,
 ...
 */
bool
Bhv_SideHalfPassRequestMove2016::doDashAdjust( PlayerAgent * agent,
                                               const Vector2D & target_point )
{
    const WorldModel & wm = agent->world();
 ...
 */
int
Bhv_SideHalfPassRequestMove2016::predictTurnStep( const WorldModel & wm,
                                                  const Vector2D & target_point,
 ...
 */
int
Bhv_SideHalfPassRequestMove2016::predictOverOffsideDashStep( const WorldModel & wm,
 ...
 */
int
Bhv_SideHalfPassRequestMove2016::predictOverOffsideStep( const WorldModel & wm,
                                                         const Vector2D & target_point,
                                                         const double dist_thr,
                                                         const int wait_step,
 ...
 */
int
Bhv_SideHalfPassRequestMove2016::getWaitToAvoidOffside( const WorldModel & wm,
                                                        const Vector2D & target_point,
                                                        const double dist_thr )
{
 ...
 */
int
Bhv_SideHalfPassRequestMove2016::getTeammateReachStep( const WorldModel & wm )
{
 ...
 */
bool
Bhv_SideHalfPassRequestMove2016::isMoveSituation( const WorldModel & wm )
{
 ...
 */
bool
Bhv_SideHalfPassRequestMove2016::checkStamina( const WorldModel & wm,
                                               const Vector2D & target_point )
{
 ...
 */
Vector2D
Bhv_SideHalfPassRequestMove2016::getTargetPoint( const rcsc::WorldModel & wm )
{
    ...
    for ( double target_x = 44.0; target_x > 35.0; target_x -= 2.0 )
    {
        ...
        for ( double target_y = home_pos.y - 20.0;
              target_y < home_pos.y + 20.0;
              target_y += 3.0 )
        {
            if ( std::fabs( target_y ) > ServerParam::i().pitchHalfWidth() - 5.0 )
            {
                continue;
            }
            ...
            // check pass course
            //
            if ( ! existPassCourse( wm, ball_pos, target_point ) )
            {
                continue;
            }
 ...
 */
bool
Bhv_SideHalfPassRequestMove2016::existPassCourse( const WorldModel & wm,
                                                  const Vector2D & ball_pos,
                                                  const Vector2D & target_point )
{
    (void)wm;
 ...
 */
double
Bhv_SideHalfPassRequestMove2016::evaluateTargetPoint( const rcsc::WorldModel & wm,
                                                      ...
                                                      const rcsc::Vector2D & target_point )
{
...

    {
        ...
        double tmp_value = -0.5 * home_y_diff;
        value += tmp_value;
#ifdef DEBUG_PRINT
    ...
    }
    {
        ...
        double tmp_value = -0.5 * ball_y_diff;
        value += tmp_value;
#ifdef DEBUG_PRINT
