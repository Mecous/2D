...
#ifndef BHV_SIDE_BACK_BLOCK_BALL_OWNER_H
#define BHV_SIDE_BACK_BLOCK_BALL_OWNER_H
...
class Bhv_SideBackBlockBallOwner
...
public:
    ...
    Bhv_SideBackBlockBallOwner( const rcsc::Rect2D & bounding_rect,
...
private:
    ...
    bool doBlockMove2012( rcsc::PlayerAgent * agent );
    bool doWait( rcsc::PlayerAgent * agent,
                 const Param & param,
                 const rcsc::Segment2D & block_line );
    void simulate2012( const rcsc::WorldModel & wm,
                       const rcsc::Vector2D & opponent_ball_pos,
                       const rcsc::Vector2D & center_pos,
