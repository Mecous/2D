...
#ifndef BHV_SIDE_HALF_PASS_REQUEST_MOVE_2016_H
#define BHV_SIDE_HALF_PASS_REQUEST_MOVE_2016_H
...
class Bhv_SideHalfPassRequestMove2016
    : public rcsc::SoccerBehavior {
public:

    Bhv_SideHalfPassRequestMove2016()
      { }
