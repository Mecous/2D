...
#ifndef RCSC_ACTION_BODY_INTERCEPT_2010_H
#define RCSC_ACTION_BODY_INTERCEPT_2010_H
...
public:
    ...
    */
    explicit
    Body_Intercept2010( const bool save_recovery = true,
