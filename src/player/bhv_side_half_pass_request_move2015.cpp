 ...
 */
bool
Bhv_SideHalfPassRequestMove2015::execute( PlayerAgent * agent )
{
 ...
 */
void
Bhv_SideHalfPassRequestMove2015::doGoToPoint( PlayerAgent * agent,
 ...
 */
bool
Bhv_SideHalfPassRequestMove2015::doDashAdjust( PlayerAgent * agent,
                                               const Vector2D & target_point )
{
    const WorldModel & wm = agent->world();
 ...
 */
int
Bhv_SideHalfPassRequestMove2015::predictTurnStep( const WorldModel & wm,
                                                  const Vector2D & target_point,
 ...
 */
int
Bhv_SideHalfPassRequestMove2015::predictOverOffsideDashStep( const WorldModel & wm,
 ...
 */
int
Bhv_SideHalfPassRequestMove2015::predictOverOffsideStep( const WorldModel & wm,
                                                         const Vector2D & target_point,
                                                         const double dist_thr,
                                                         const int wait_step,
 ...
 */
int
Bhv_SideHalfPassRequestMove2015::getWaitToAvoidOffside( const WorldModel & wm,
                                                        const Vector2D & target_point,
                                                        const double dist_thr )
{
 ...
 */
int
Bhv_SideHalfPassRequestMove2015::getTeammateReachStep( const WorldModel & wm )
{
 ...
 */
bool
Bhv_SideHalfPassRequestMove2015::isMoveSituation( const WorldModel & wm )
{
 ...
 */
bool
Bhv_SideHalfPassRequestMove2015::checkStamina( const WorldModel & wm,
                                               const Vector2D & target_point )
{
 ...
 */
Vector2D
Bhv_SideHalfPassRequestMove2015::getTargetPoint( const rcsc::WorldModel & wm )
{
 ...
 */
double
Bhv_SideHalfPassRequestMove2015::evaluateTargetPoint( const rcsc::WorldModel & wm,
