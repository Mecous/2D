 ...
 */
GeneratorTackle::Result::Result( const int index,
 ...
 */
GeneratorTackle::GeneratorTackle()
{
 ...
 */
GeneratorTackle &
GeneratorTackle::instance()
{
    static GeneratorTackle s_instance;
    return s_instance;
}
 ...
 */
void
GeneratorTackle::generate( const WorldModel & wm )
{
 ...
 */
void
GeneratorTackle::calculate( const WorldModel & wm )
{
 ...
 */
double
GeneratorTackle::evaluate( const WorldModel & wm,
                           const Result & result )
{
    const ServerParam & SP = ServerParam::i();
 ...
 */
double
GeneratorTackle::getOneStepMinimumOpponentDistance2( const WorldModel & wm,
 ...
 */
int
GeneratorTackle::predictOpponentsReachStep( const WorldModel & wm,
                                            const Vector2D & first_ball_pos,
                                            const Vector2D & first_ball_vel,
 ...
 */
int
GeneratorTackle::predictOpponentReachStep( const AbstractPlayerObject * opponent,
                                           const Vector2D & first_ball_pos,
                                           const Vector2D & first_ball_vel,
                                           const AngleDeg & ball_move_angle,
                                           const int max_cycle )
