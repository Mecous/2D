...
const std::string RoleCenterHalf::NAME( "CenterHalf" );
 ...
 */
namespace {
rcss::RegHolder role = SoccerRole::creators().autoReg( &RoleCenterHalf::create,
                                                       RoleCenterHalf::NAME );
}
 ...
 */
bool
RoleCenterHalf::execute( PlayerAgent * agent )
{
 ...
 */
void
RoleCenterHalf::doKick( PlayerAgent * agent )
{
 ...
 */
void
RoleCenterHalf::doMove( PlayerAgent * agent )
{
