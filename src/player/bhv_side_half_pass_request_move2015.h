...
#ifndef BHV_SIDE_HALF_PASS_REQUEST_MOVE_2015_H
#define BHV_SIDE_HALF_PASS_REQUEST_MOVE_2015_H
...
class Bhv_SideHalfPassRequestMove2015
    : public rcsc::SoccerBehavior {
public:

    Bhv_SideHalfPassRequestMove2015()
      { }
