 ...
 */
void
ActGen_Pass::generate( std::vector< ActionStatePair > * result,
                       ...
                       const std::vector< ActionStatePair > & path ) const
{
    ...
    const std::vector< CooperativeAction::Ptr > & courses = GeneratorPass::instance().courses( wm );

    //
    // add pass course candidates
    //
    for ( std::vector< CooperativeAction::Ptr >::const_iterator act = courses.begin(), end = courses.end();
          act != end;
          ++act )
    {
