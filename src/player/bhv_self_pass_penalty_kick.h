...
/*!
  \file bhv_self_pass_penalty_kick.h
  \brief pass to self action for penalty kick mode.
*/
...
#ifndef HELIOS_BHV_SELF_PASS_PENALTY_KICK_H
#define HELIOS_BHV_SELF_PASS_PENALTY_KICK_H
