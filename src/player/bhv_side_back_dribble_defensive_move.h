...
#ifndef HELIOS_BHV_SIDE_BACK_DRIBBLE_DEFENSIVE_MOVE_H
#define HELIOS_BHV_SIDE_BACK_DRIBBLE_DEFENSIVE_MOVE_H
...
class Bhv_SideBackDribbleDefensiveMove
    : public rcsc::SoccerBehavior {
public:
    Bhv_SideBackDribbleDefensiveMove()
      { }
